...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <body>
    ...
    <div class="container">
    	<legend>Mantenedor de Regiones</legend>
    	
    	<p style="text-align:right;"><a class='btn btn-success' href='#dlgAgregar' data-toggle='modal'><i class='icon-file icon-white'></i>Agregar Regi&oacute;n</a></p>
    	<!--TABLA DE BUSCADORES-->
		...
		<div id="dlgAgregar" class="modal hide fade" tabindex="-1" role="dialog">
		  <div class="modal-header">
		    ...
		    <h3 id="myModalLabel">Nueva Regi&oacute;n</h3>
		  </div>
		    ...
		    <form class="form-horizontal" id="form_nuevo">  
		        ...
		        <fieldset>  
		          <div class="control-group">  
		            ...
		            <div class="controls">  
		                <input type="text" class="input-xlarge" id="Nueva_region_nombre" placeholder="Nombre de la Región">	            
		            </div>  
		          </div>
		          <div class="control-group">  
		            <label class="control-label" for="NuevoNombre">Abreviaci&oacute;n.</label>  
		            <div class="controls">
		              <input type="text" class="input-xlarge" id="Nueva_region_abb" placeholder="NR">
		              <!--p class="help-block"></p-->  
		            </div>
		          </div>
		          <div class="control-group">  
		            <label class="control-label" for="NuevoNombre">Pa&iacute;s.</label>  
		            <div class="controls">
		              <select id="Nueva_region_pais"></select>
		              <!--p class="help-block"></p-->  
		            </div>
		          </div>
		        </fieldset>
		...
		<div id="dlgModificar" class="modal hide fade" tabindex="-1" role="dialog">
		  <div class="modal-header">
		    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		    <h3 id="myModalLabel">Editar Regi&oacute;n</h3>
		  </div>
		  <div class="modal-body">
		    <form class="form-horizontal" id="form_nuevo">  
		        ...
		        <fieldset>
		            ...
		            <label class="control-label" for="perfiles">Nombre</label>  
		            <div class="controls">  
		                <input type="text" class="input-xlarge" id="mNueva_region_nombre" placeholder="Nombre de la Región">	            
		            </div>  
		          </div>
		          <div class="control-group">  
		            <label class="control-label" for="NuevoNombre">Abreviaci&oacute;n.</label>  
		            <div class="controls">
		              <input type="text" class="input-xlarge" id="mNueva_region_abb" placeholder="NR">
		              <!--p class="help-block"></p-->  
		            </div>
		          </div>
		          <div class="control-group">  
		            <label class="control-label" for="NuevoNombre">Pa&iacute;s.</label>  
		            <div class="controls">
		              <select id="mNueva_region_pais"></select>
		              <!--p class="help-block"></p-->  
		            </div>
		          </div>
		        </fieldset>  
	...
	<script type="text/javascript" src="controlador/regiones.js"></script>
