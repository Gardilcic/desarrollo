            ...
            <form class="form-horizontal" id="form_nuevo">
                ...
                <fieldset>
                    <div class="control-group">  
                        ...
                        <div class="controls">  
                            <textarea id="p_detalle" cols="30" rows="12" readonly="readonly" style="width:260px; height:300px;">
                            </textarea>            
                        </div>  
                    </div>
                </fieldset>		        
...
$.ajax(
{
    ...
    success: function(datos)
    {
 	   ...
 	   {
 	   		$('#p_detalle').val('No existe información para esta página');
 	   }
    }
 });
</script>