    ...
    <body>
        ...
        <div class="container">
            ...
            <div style="position: relative; float: left;">
                ...
                <p class="text-success"><b>Itemizado de Subproyecto</b></p>
                <div class="form-horizontal">
                	<!--<div class="control-group">
                        <label class="control-label" style="text-align: left; width: 100px;" for="versiones">Empresa </label>
                    ...
                    <div class="control-group">
                        <label class="control-label" style="text-align: left; width: 100px;" for="subproyectos">Proyecto </label>
                        <div class="controls" style="margin-left: 50px;" >
                            <select id="proyectos">
                                <option>Selecciones</option>
                            </select>
            ...
            <div style="position: relative; float: left; margin-left: 30px; width: 700px;">
                <div style="position: relative; float: left; width: 700px; padding-bottom: 10px;">
                    <span class="text-success"><b>Actividades sin relacionar</b></span>
        ...
        <script type="text/javascript" src="controlador/relacionar_actividades_itemizado.js"></script>
