...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <body>
    ...
    <div class="container">
    	<legend>Mantenedor de Perspectivas</legend>
    	
    	<p style="text-align:right;"><a class='btn btn-success' href='#dlgAgregar' data-toggle='modal'><i class='icon-file icon-white'></i>Nueva Perspectiva</a></p>
    	<!--TABLA DE BUSCADORES-->
		...
		<div id="dlgAgregar" class="modal hide fade" tabindex="-1" role="dialog">
		  <div class="modal-header">
		    ...
		    <h3 id="myModalLabel">Nueva Perspectiva</h3>
		  </div>
		    ...
		    <form class="form-horizontal" id="form_nuevo">  
		        ...
		        <fieldset>  
		          <div class="control-group">  
		            ...
		            <div class="controls">  
		                <input type="text" class="input-xlarge" id="Nueva_perspectiva_nombre" placeholder="Nombre nuevo">	            
		            </div>
		          </div>
		          <div class="control-group">  
		            <label class="control-label" for="NuevoNombre">Estado</label>  
		            <div class="controls">
		            <select id="Nueva_perspectiva_estado"></select>
		...
		<div id="dlgModificar" class="modal hide fade" tabindex="-1" role="dialog">
		  <div class="modal-header">
		    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		    <h3 id="myModalLabel">Editar Perspectiva</h3>
		  </div>
		  <div class="modal-body">
		    <form class="form-horizontal" id="form_nuevo">  
		        ...
		        <fieldset>
		          ...
		          <div class="control-group">  
		            ...
		            <div class="controls">  
		                <input type="text" class="input-xlarge" id="mNueva_perspectiva_nombre" placeholder="Nombre">	            
		            </div>  
		          </div>
		          <div class="control-group">  
		            <label class="control-label" for="NuevoNombre">Estado</label>  
		            <div class="controls">  
		              <select id="mNueva_perspectiva_estado"></select>
		              <!--p class="help-block"></p-->  
		            </div>
		          </div>
		        </fieldset>  
	...
	<script type="text/javascript" src="controlador/perspectivas.js"></script>
