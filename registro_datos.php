...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">            
            ...
            <p><span style="position: relative; float:left; height: 15px; width: 40px; background-color: red; margin: 0px 5px;"></span> Dato ingresado <b>atrasado</b> y/o modificado respecto a la fecha programada.</p>
        ...
        <script type="text/javascript" src="controlador/registro_dato.js"></script>
