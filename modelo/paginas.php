...
if ($_POST['funcion'] == "nuevo_permisos_por_modulo") {
    ...
    $cns = "DECLARE @registro Permisos;";
    foreach ($permisos as $key => $value) {
        $cns .= "INSERT INTO @registro VALUES ('$value');";
    }    
    
    $cns .= "EXEC dbo.asignar_permisos_usuario @usuario = N'$_POST[usuario]' , @permisos = @registro, @modulo = '$_POST[modulo]'; ";
    $a = get_datos($cns);
...
// 24-06-2013 
if($_POST['funcion']=="ListarPermisosMenu")
{
    $var1 = "SELECT [id]
              ,[nombre]
              ,[url]
          ...
          FROM [dbo].[vista_permisos_menu] 
          WHERE id_modulo = $_POST[modulo] 
...
if($_POST['funcion']=="DesvincularPaginaDelMenu")
{
    $var1 = "UPDATE [sigp_usuarios].[dbo].[permisos] SET
              id_submenu = null,
              orden = null
          WHERE id = $_POST[pagina]";    
    $a = get_datos_sigp($var1);
