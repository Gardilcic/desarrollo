...
if($_POST['funcion']=="Listar_frecuencias"){
		
	$var1 = "select id, descripcion, numero_dias, nombre_estados from vista_frecuencias order by descripcion asc" ;	
...
if($_POST['funcion']=="nueva_frecuencia"){
		//echo "ListarUsuarios";
		
		$cns = "insert into frecuencia (descripcion, numero_dias, id_estados) values ('".decoder($_POST['nombre'])."',".$_POST['periodo'].",".$_POST['estado'].")";
		//echo $cns;
		$a = get_datos($cns);
...
if($_POST['funcion']=="updt_frecuencia")
{
	$cns = "update frecuencia set descripcion='".decoder($_POST['nombre'])."', numero_dias=".$_POST['periodo'].", id_estados=".$_POST['estado']." where id=".$_POST['id'];
	//echo $cns;
	$a = get_datos($cns);
}
...
if($_POST['funcion']=="eliminar_frecuencia")
{
	$respuesta = 0;
	$error = 5;
	$cns0="delete from frecuencia where id =".$_POST['id'];
	//echo $cns0;
