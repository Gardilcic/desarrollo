...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <body>
    ...
    <div class="container">
    	<legend>Mantenedor de Unidades de Registros</legend>
    	
    	<p style="text-align:right;">
    		<a class='btn btn-success' href='#dlgAgregar' data-toggle='modal'>
    			<i class='icon-file icon-white'></i>Agregar Unidad
    		</a>
    	</p>
    	<!--TABLA DE BUSCADORES-->
		...
		<div id="dlgAgregar" class="modal hide fade" tabindex="-1" role="dialog">
		  <div class="modal-header">
		    ...
		    <h3 id="myModalLabel">Nueva Unidad</h3>
		  </div>
		    ...
		    <form class="form-horizontal" id="form_nuevo">  
		        ...
		        <fieldset>  
		          <div class="control-group">  
		            ...
		            <div class="controls">  
		                <input type="text" class="input-xlarge" id="Nuevo_nombre" placeholder="Nueva unidad">	            
		            </div>  
		          </div>
		          <div class="control-group">  
		            <label class="control-label" for="perfiles">Abreviaci&oacute;n</label>  
		            <div class="controls">  
		                <input type="text" class="input-xlarge" id="Nuevo_abb" placeholder="M2/Ml/M3">	            
		            </div>  
		          </div>
		          <div class="control-group">  
		...
		<div id="dlgModificar" class="modal hide fade" tabindex="-1" role="dialog">
		  <div class="modal-header">
		    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		    <h3 id="myModalLabel">Modificar Unidad</h3>
		  </div>
		  <div class="modal-body">
		    <form class="form-horizontal" id="form_nuevo">  
		        ...
		        <fieldset>
		          ...
		          <div class="control-group">  
		            <label class="control-label" for="perfiles">Abreviaci&oacute;n</label>  
		            <div class="controls">  
		                <input type="text" class="input-xlarge" id="mNuevo_abb" placeholder="Nuevo Módulo">	            
		            </div>  
		          </div>
		          <div class="control-group">  
		            <label class="control-label" for="NuevoNombre">Estado.</label>  
	...
	<script type="text/javascript" src="controlador/unidades_registro.js"></script>
