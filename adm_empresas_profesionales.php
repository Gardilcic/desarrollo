...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <body>
    ...
    <div class="container">
    	<legend>Mantenedor de Profesionales Empresas</legend>
    	
    	<p style="text-align:right;">
    		<a class='btn btn-success' href='#dlgAgregar' data-toggle='modal'>
    			<i class='icon-file icon-white'></i>Agregar Profesional
    		</a>
    	</p>
    	<!--TABLA DE BUSCADORES-->
		<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover" id="example">
			<thead>
				<tr>
					...
					<th>Empresa</th>
					<th>Estado</th>
					<th>Vigencia <br />(&uacute;ltima desactivaci&oacute;n)</th>
					<th>Acciones</th>
				</tr>
			</thead>
			<tbody id="tabla_body">
		...
		<div id="dlgAgregar" class="modal hide fade" tabindex="-1" role="dialog">
		  <div class="modal-header">
		    ...
		    <h3 id="myModalLabel">Nuevo Profesional</h3>
		  </div>
		    ...
		    <form class="form-horizontal" id="form_nuevo">  
		        ...
		        <fieldset>  
		          <div class="control-group">  
		            ...
		            <div class="controls">  
		                <input type="text" class="input-xlarge" id="Nuevo_nombre" placeholder="Nombre y Apellido de la persona">	            
		            </div>  
		          </div>
		          <div class="control-group">  
		            <label class="control-label" for="perfiles">Empresa</label>  
		            <div class="controls">  
		                <select name="empresa" id="Nuevo_empresa"></select>	            
		            </div>  
		          </div>
		          <div class="control-group">  
		            <label class="control-label" for="perfiles">Vigencia</label>  
		            <div class="controls">  
						<input type="text" class="input-xlarge" id="Nuevo_vigencia" readonly="readonly" placeholder="Usuario activo.">
		            </div>  
		          </div>
		          <div class="control-group">  
		...
		<div id="dlgModificar" class="modal hide fade" tabindex="-1" role="dialog">
		  <div class="modal-header">
		    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		    <h3 id="myModalLabel">Modificar Profesional</h3>
		  </div>
		  <div class="modal-body">
		    <form class="form-horizontal" id="form_nuevo">  
		        ...
		        <fieldset>
		          ...
		          <div class="control-group">  
		            <label class="control-label" for="perfiles">Empresa</label>  
		            <div class="controls">  
						<select name="empresa" id="mNuevo_empresa"></select>
		            </div>  
		          </div>
		          <div class="control-group">  
		            <label class="control-label" for="perfiles">Vigencia</label>  
		            <div class="controls">  
						<input type="text" class="input-xlarge" id="mNuevo_vigencia" readonly="readonly" placeholder="Usuario activo.">
		            </div>  
		          </div>
		          <div class="control-group">  
		            <label class="control-label" for="NuevoNombre">Estado.</label>  
	...
	<script type="text/javascript" src="controlador/empresas_profesionales.js"></script>
