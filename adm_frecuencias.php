...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <body>
    ...
    <div class="container">
    	<legend>Mantenedor de Frecuencias</legend>
    	
    	<p style="text-align:right;"><a class='btn btn-success' href='#dlgAgregar' data-toggle='modal'><i class='icon-file icon-white'></i>Nueva Frecuencia</a></p>
    	<!--TABLA DE BUSCADORES-->
		...
		<div id="dlgAgregar" class="modal hide fade" tabindex="-1" role="dialog">
		  <div class="modal-header">
		    ...
		    <h3 id="myModalLabel">Nueva Frecuencia</h3>
		  </div>
		    ...
		    <form class="form-horizontal" id="form_nuevo">  
		        ...
		        <fieldset>  
		          <div class="control-group">  
		            ...
		            <div class="controls">  
		                <input type="text" class="input-xlarge" id="Nueva_frecuencia_nombre" placeholder="Nombre nuevo">	            
		            </div>
		          </div>
		          <div class="control-group">  
		            <label class="control-label" for="NuevoNombre">N&uacute;mero de d&iacute;as</label>  
		            <div class="controls">
		            	<input type="number" class="input-xlarge" id="Nueva_frecuencia_periodo" placeholder="Nombre nuevo">
		          ...
		          <div class="control-group">  
		            ...
		            <div class="controls">
		            <select id="Nueva_frecuencia_estado"></select>
		              <!--p class="help-block"></p-->  
		            </div>
		          </div>
		        </fieldset>
		...
		<div id="dlgModificar" class="modal hide fade" tabindex="-1" role="dialog">
		  <div class="modal-header">
		    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		    <h3 id="myModalLabel">Editar Frecuencia</h3>
		  </div>
		  <div class="modal-body">
		    <form class="form-horizontal" id="form_nuevo">  
		        ...
		        <fieldset>
		          ...
		          <div class="control-group">  
		            ...
		            <div class="controls">  
		                <input type="text" class="input-xlarge" id="mNueva_frecuencia_nombre" placeholder="Nombre">	            
		            </div>  
		          </div>
		          <div class="control-group">  
		            <label class="control-label" for="NuevoNombre">N&uacute;mero de d&iacute;as</label>  
		            <div class="controls">  
		              <input type="number" class="input-xlarge" id="mNueva_frecuencia_periodo" placeholder="Nombre nuevo">
		              <!--p class="help-block"></p-->  
		            </div>
		          </div>
		          <div class="control-group">  
		            <label class="control-label" for="NuevoNombre">Estado</label>  
		            <div class="controls">  
		              <select id="mNueva_frecuencia_estado"></select>
		              <!--p class="help-block"></p-->  
		            </div>
		          </div>
		        </fieldset>  
	...
	<script type="text/javascript" src="controlador/frecuencias.js"></script>
