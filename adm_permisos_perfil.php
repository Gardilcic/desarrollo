...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <body>
    ...
    <div class="container">
    	<legend>Mantenedor de P&aacute;ginas y Perfiles</legend>
    	
    	<p style="text-align:right;">
    		<a class='btn btn-success' href='#dlgAgregar' data-toggle='modal'>
    			<i class='icon-file icon-white'></i>Agregar Relaci&oacute;n
    		</a>
    	</p>
    	<!--TABLA DE BUSCADORES-->
		...
		<div id="dlgAgregar" class="modal hide fade" tabindex="-1" role="dialog">
		  <div class="modal-header">
		    ...
		    <h3 id="myModalLabel">Nueva asociación</h3>
		  </div>
		    ...
		    <form class="form-horizontal" id="form_nuevo">  
		        ...
		        <fieldset>  
		          <div class="control-group">  
		            ...
		            <div class="controls">  
		           		<select id="perfiles_lista"></select>
		            </div>  
		          </div>
		          <div class="control-group">  
		            <label class="control-label" for="perfiles">Permisos</label>  
		            <div class="controls">  
		            	<select id="lista_permisos" multiple="multiple" class="input-xlarge" size="15"></select>
		            	<!--<select multiple="multiple" id="lista_permisos"></select>-->
		            </div>  
		          </div>
		          <div class="control-group">  
		            <label class="control-label" for="perfiles"></label>  
		            <div class="controls">  
		            	Seleccionar todos <input type="checkbox" id="sel_todos" />
		            	<!--<select multiple="multiple" id="lista_permisos"></select>-->
		            </div>  
		          </div>
		        </fieldset>
		...
		<div id="dlgModificar" class="modal hide fade" tabindex="-1" role="dialog">
		  <div class="modal-header">
		    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		    <h3 id="myModalLabel">Modificar Permiso</h3>
		  </div>
		  <div class="modal-body">
		    <form class="form-horizontal" id="form_nuevo">  
		        ...
		        <fieldset>
		          ...
		          <div class="control-group">  
		            ...
		            <div class="controls">  
		                <input type="text" class="input-xlarge" id="mNuevo_url" placeholder="Nuevo Módulo">	            
		            </div>  
		          </div>
		          <div class="control-group">  
	...
	<script type="text/javascript" src="controlador/permisos_perfil.js"></script>
