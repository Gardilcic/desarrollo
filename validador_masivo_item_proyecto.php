<?php 
	...
	{*/
		...
		$archivo_ini = $_FILES['archivo']['tmp_name'];//['archivo']['tmp_name'];
                //alert('Por .'.$_FILES['archivo']['tmp_name']);
		...
		if (!file_exists($ruta))
		{
			...
			header("Location: adm_carga_xls.php");
		}
        ...
        <div class="container">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="row-fluid">
                        <div class="span10">
                            <legend>Mantenedor de Itemizado Subproyecto</legend>
                        </div>
            ...
            <?php
            	...
            	if(file_exists('libs/cargas_masivas/'.$archivo))
            	{
            		...
            		lectura_subpro("libs/cargas_masivas/".$archivo, $version, $subproyecto);
